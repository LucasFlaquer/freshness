...
const owlCarousel = {
  main: path.root + "node_modules/owl.carousel/dist/assets/owl.carousel.min.css",
  default: path.root + "node_modules/owl.carousel/dist/assets/owl.theme.default.min.css",
  js:path.root + "node_modules/owl.carousel/dist/owl.carousel.min.js"
}
...
function vendorJs() {
  ...
  return gulp.src([bootstrap, popper, jquery, owlCarousel.js])
    .pipe(gulp.dest(path.dist.js));
}
function pluginCss() {
  return gulp.src([owlCarousel.main, owlCarousel.default])
    .pipe(gulp.dest(path.dist.css));
}
...
const buildCss = gulp.parallel(css, pluginCss);
const build =gulp.series(clear, gulp.parallel(html,buildCss,buildJs, fonts, samples));
function watch() {
